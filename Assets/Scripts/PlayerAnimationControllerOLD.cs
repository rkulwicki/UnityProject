...
public class PlayerAnimationControllerOLD : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //fall
        if (_jump.falling && _mi.rightFacing && !_mi.upFacing)
            JumpFrontRight();
        else if (_jump.falling && !_mi.rightFacing && !_mi.upFacing)
            JumpFrontLeft();
        //fall back
        else if (_jump.falling && _mi.rightFacing && _mi.upFacing)
            JumpFrontRight();//JumpBackRight();
